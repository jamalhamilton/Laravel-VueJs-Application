...
@section('content')
   ...
   <section class="userSection ptb_80">
     <div class="container">
       <div class="row">
         <div class="col-lg-4">
           <div class="white-bg Red">
             <div class="userImg"><img src="/front/images/userIcon.png"></div>
             <div class="userInfo">
               <h3>Alexa Sekercak
                 <span>Male, 22</span>
               </h3>
         ...
         <div class="col-lg-4">
           <div class="white-bg Green">
             <div class="userImg zoom"><img src="/front/images/userIcon.png"></div>
             <div class="userInfo">
               <h3>Alexa Sekercak
                 <span>Male, 22</span>
               </h3>
